-- Peptide cycle state tracking with user unique constraint
...
create unique index if not exists peptide_cycle_status_user_unique on public.peptide_cycle_status(user_id);
